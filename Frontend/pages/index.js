              ...
              <li className="flex items-center">
                <Link href="/auth/login">
                  <button className="bg-white text-blueGray-700 active:bg-blueGray-50 text-sm font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150" type="button">
                    <i className="fas fa-arrow-alt-circle-right"></i> Login</button>
                </Link>
              </li>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    src="https://media.licdn.com/dms/image/C4D03AQHNA5ITzGLIUQ/profile-displayphoto-shrink_400_400/0/1633376065480?e=1682553600&v=beta&t=BEF51vi5lU31bmiEATlmtkjpzK39M_LJ71fgPRZP4Bo"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    src="https://media.licdn.com/dms/image/D4D03AQFvG5Ohoagftg/profile-displayphoto-shrink_100_100/0/1667672509334?e=1682553600&v=beta&t=U0Gl2hJRfHdJHSQOa4XxCHaKbO5v1lsHEBRrCpPgU6w"
                    className="shadow-lg rounded-full mx-auto max-w-120-px"
                  />
                  <div className="pt-6 text-center">
              ...
              <div className="w-full px-4">
                ...
                <ul>
                  ...
                  <li className="text-lg leading-relaxed mt-6 mb-2 text-blueGray-400">
                    To ease the process of Document Verification and checking for Cops!
                  </li>

                  <li className="text-lg leading-relaxed mt-2 mb-2 text-blueGray-400">
                    To create a system that actually increase the overall throughput of the vehicle document checking process.
                  </li>

                  <li className="text-lg leading-relaxed mt-2 mb-2 text-blueGray-400">
                    To help vehicle owners to manage their documents and produce it on spot with the help of QR-Code with little or no ambiguity.
                  </li>

                  <li className="text-lg leading-relaxed mt-2 mb-2 text-blueGray-400">
                    To create a system that allows user to generate a QR-Code of documents uploaded which can be glued on the front mirror of the Vehicle.
                  </li>
